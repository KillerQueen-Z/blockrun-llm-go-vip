...
var modelCatalog = []Model{
	...
	{ID: "google/gemini-3.5-flash", Name: "Gemini 3.5 Flash", Provider: "google", Categories: []string{"chat", "reasoning", "coding", "vision"}, ContextWindow: 1048576, MaxOutput: 65536, BillingMode: "paid", Pricing: ModelPricing{InputPerMillion: 0.5, OutputPerMillion: 3}},
